...
const handler = async (m, {conn, text, isMods, isOwner, isPrems}) => {
 if (enviando) return;
  ...
  try {
    ...
    if (!link || !link.match(linkRegex)) throw 'Contrata mis servicios con mis desarrolladores\nhttps://wa.me/+593958989535\nhttps://wa.me/50250148981';
    ...
    if ( isPrems || isMods || isOwner || m.fromMe) {
      ...
      conn.sendMessage(m.chat, {text: 'Contrata mis servicios con mis desarrolladores\nhttps://wa.me/+593958989535\nhttps://wa.me/50250148981'}, {quoted: m});
